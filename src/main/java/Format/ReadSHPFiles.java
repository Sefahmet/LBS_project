...
public class ReadSHPFiles {
    public static void main(String[] args) {
        // get bounds, getvalue
        FeatureCollection featureCollection =  readShapeFiles("/Users/sefahmet/Desktop/2. Semester/LBS/Last Data/Buildings.shp");


        Point2D.Double current  = new Point2D.Double(   365023.390,5621258.603);
        Point2D.Double  direction = new Point2D.Double( 365057.84, 5621229.73);

        System.out.println(getClosestBuildingsInformations(featureCollection,current,direction));
    ...
    public static String getClosestBuildingsInformations(FeatureCollection featureCollection, Point2D.Double current, Point2D.Double direction){
        Integer alfa = 20;
    ...
    public static String buildingPosition(Point2D p1,Point2D p2,Point2D p3){
    ...
    public static HashMap<String,Object> buildingInformationForPoint(Point2D.Double current,Point2D.Double direction, String multiPoly){
